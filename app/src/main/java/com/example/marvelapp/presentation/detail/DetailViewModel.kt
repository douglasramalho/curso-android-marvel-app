...
class DetailViewModel @Inject constructor(
    ...
    fun getCaracterCatergories(characterId: Int) = viewModelScope.launch {
        getCharacterCategories(GetCharacterCategoriesUseCase.GetComicsParams(characterId)).watchStatus()
    }
